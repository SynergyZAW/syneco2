...
{/* Patient (auth-gated live-data vertical) */}
<Route path="/patient" element={<RequireAuth><PatientDashboard /></RequireAuth>} />
<Route path="/patient/onboarding" element={<RequireAuth><OnboardingWizard /></RequireAuth>} />
<Route path="/patient/status" element={<RequireAuth><RegulatoryStatus /></RequireAuth>} />
<Route path="/patient/card" element={<RequireAuth><DigitalCard /></RequireAuth>} />
<Route path="/patient/shop" element={<RequireAuth><MedicineShop /></RequireAuth>} />
<Route path="/patient/shop/:productId" element={<RequireAuth><ProductDetail /></RequireAuth>} />
<Route path="/patient/support" element={<RequireAuth><Support /></RequireAuth>} />
<Route path="/patient/profile" element={<RequireAuth><Profile /></RequireAuth>} />
{/* Doctor */}
